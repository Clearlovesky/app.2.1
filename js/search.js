        ...
        var title ='';
			  $(".list2 li").on("click",function(){
			  	...
			  	title=$(this).find("p").text();
					if(Number(type)==2){
			  		window.location.href='information.html?type=' + type + '&title='+ title +"&drysalteryFileID="+drysalteryFileID;
					}else{
						window.location.href='lesson_info.html?type=' + type + '&title='+ title +"&drysalteryFileID="+drysalteryFileID;
					}
